...
// ponytail: canonical check lives in lib/eligibility — re-exported so existing imports keep working
import { evaluateFitness } from "@/lib/eligibility";
export { evaluateFitness };
export type { FitnessEvaluation } from "@/lib/eligibility";
